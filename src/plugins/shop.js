  ...
  drawPrize(lv) {
    ...
    const getAttribute = (type, lv, attribute) => {
      ...
      const attrs = {
        ...
        dodge: ['accessory', 'sutra', 'pet'].includes(type) ? dodge : 0,
        attack: ['weapon', 'accessory', 'sutra', 'pet'].includes(type) ? Attack * multiplier : 0,
        health: ['armor', 'accessory', 'sutra', 'pet'].includes(type) ? Health * multiplier : 0,
        defense: ['armor', 'accessory', 'sutra', 'pet'].includes(type) ? defense * multiplier : 0,
        critical: ['weapon', 'accessory', 'sutra', 'pet'].includes(type) ? CriticalHitrate : 0,
      }
