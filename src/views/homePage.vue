<template>
    <div class="index">
        <div class="index-box">
            ...
            <div class="attributes">
                <div class="attribute-box">
                    ...
                    <div class="tag attribute"
                        @click="$notifys({ title: '获得方式', message: '每提成一次境界可以获得3点境界点' })">
                    ...
                    <div class="tag attribute"
                        @click="$notifys({ title: '获得方式', message: '每转生一次可以增加50容量' })">
            ...
            <div class="equip-box">
                <div class="tag equip-item">
                    <span class="equip">
                        <span>神兵: </span>
                        <tag v-if="player.equipment.weapon?.name"
                    ...
                    <span class="equip">
                        <span>护甲: </span>
                        <tag v-if="player.equipment.armor?.name"
                ...
                <div class="tag equip-item">
                    <span class="equip">
                        <span>灵宝: </span>
                        <tag v-if="player.equipment.accessory?.name"
                    ...
                    <span class="equip">
                        <span>法器: </span>
                        <tag v-if="player.equipment.sutra?.name"
                ...
                <div class="tag inventory-box">
                    <el-tabs v-model="inventoryActive"
                        :stretch="true">
        ...
        <el-drawer :title="player.wife.name"
        ...
        <el-drawer :title="player.pet.name"
            v-model="petItemShow"
            direction="rtl"
            class="strengthen">
            <div class="strengthen-box">
        ...
        <el-dialog :title="petInfo.name"
            ...
            <el-collapse v-model="petCollapse"
                class="collapse">
        ...
        <el-dialog v-model="show"
            ...
            <div class="dialog-footer">
                ...
                <el-button type="success"
                    class="dialog-footer-button"
                    @click="copyContent('url')">开源地址</el-button>
                <el-divider>当前版本为: {{ ver }}</el-divider>
            </div>
        </el-dialog>
        <el-drawer title="图鉴与成就"
            v-model="equipAllShow"
            direction="rtl"
            class="equipAll">
            <el-tabs v-model="activeName"
                type="border-card">
                <el-tab-pane label="装备图鉴"
                    name="illustrations">
                    <div class="equipAll-box">
                        <el-tabs v-model="illustrationsActive"
                            :stretch="true">
                            <el-tab-pane :label="i.name"
                                :name="i.type"
                ...
                <el-tab-pane label="我的成就"
                    name="achievement">
                    <el-tabs v-model="achievementActive"
                        :stretch="true">
                        <el-tab-pane :label="i.name"
                            :name="i.type"
        ...
        <el-drawer title="新手礼包"
            v-model="newBieBox"
            :before-close="confirmCollectionNewBie"
            class="newBieBox"
            direction="rtl">
            <div class="newBie">
                <tag v-for="(item, index) in newBieData"
                    class="inventory-item"
                    :type="item.quality"
                    :key="index"
            ...
            <el-button type="primary"
                ...
                @click="refreshNewBie">{{ newBieLoading ? '刷新中...' :
                '刷新装备'}}</el-button>
            <el-button type="primary"
                @click="confirmCollectionNewBie">领取装备</el-button>
        </el-drawer>
        <el-dialog v-model="newBieInfoBox"
            ...
            <div class="dialog-footer">
                <el-button type="primary"
                    class="inventory-button"
                    @click="newBieInfoBox = false">确定</el-button>
            </div>
        </el-dialog>
        <el-dialog v-model="errBox"
            title="错误信息"
            width="420px">
            <el-input v-model="err"
                :rows="10"
                type="textarea" />
            <div class="dialog-footer">
                <el-button type="primary"
                    class="inventory-button"
                    @click="errBox = false">确定</el-button>
            </div>
        </el-dialog>
        <offline />
    </div>
    ...
    methods: {
        ...
        attributePoints(type) {
            ...
            if (this.player.points > 0) {
                const num = this.player.reincarnation ? this.player.reincarnation * 10 : 100000000;
